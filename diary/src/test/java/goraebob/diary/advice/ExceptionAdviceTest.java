...
import goraebob.diary.controller.sign.SignController;
import goraebob.diary.dto.sign.SignInRequest;
import goraebob.diary.dto.sign.SignUpRequest;
import goraebob.diary.exception.LoginFailureException;
import goraebob.diary.exception.MemberEmailAlreadyExistsException;
import goraebob.diary.exception.MemberNicknameAlreadyExistsException;
...
class SignControllerAdviceTest {
    ...
    void signInLoginFailureExceptionTest() throws Exception {
        ...
        given(signService.signIn(any())).willThrow(LoginFailureException.class); //가짜 객체로 만들어둔 SignService.signIn을 호출했을 때, LoginFailureException.class를 throw하도록 설정
